...
const formatStringByWordsLength = require('..exercise_08/formatStringByWordsLength');
const getDistanceMessageFromSumTo100 = require('.exercise_09/getDistanceMessageFromSumTo100');
const transformCollectionToString = require('./transformCollectionToString');
...
const distanceMessage2 = getDistanceMessageFromSumTo100(30);
console.log(`Distance message: ${distanceMessage2}`);

const transformedString2 = transformCollectionToString([]);
console.log(`Transformed string: ${transformedString2}`);
